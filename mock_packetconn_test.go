...
//
//	mockgen -typed -package quic -self_package github.com/sardanioss/quic-go -self_package github.com/sardanioss/quic-go -destination mock_packetconn_test.go net PacketConn
//
